            ...
            <form action="" method="post" class="card p-4 bg-dark rounded-4">
                ...
                <div class="form-group mb-5">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <input type="password" class="form-control pt-1 pb-1" id="password" name="password" placeholder="Masukkan Password" <?= isset($_SESSION['lockout_time']) && $_SESSION['lockout_time'] > time() ? 'disabled' : '' ?>>
                        <div class="input-icon text-secondary ms-2">
                            <i class="bi bi-eye-fill toggle-password"></i>
                        </div>
                    </div>
                </div>
                <button type="submit" name="login" class="btn btn-primary btn-block p-2" <?= isset($_SESSION['lockout_time']) && $_SESSION['lockout_time'] > time() ? 'disabled' : '' ?>>Login</button>
            </form>
