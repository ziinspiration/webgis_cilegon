...
$query = "SELECT * FROM sarana WHERE nama_sarana LIKE '%$keyword%' OR kategori LIKE '%$keyword%'  OR file_json LIKE '%$keyword%'";
$getdata = query($query);
?>
    ...
    <table class="table table-striped m-auto mt-1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $a['nama_sarana']; ?></td>
                <td><?= $a['file_json']; ?></td>
                <td class="text-center"><a href="form-update-sarana.php?id=<?= $a["id"] ?>"><span
