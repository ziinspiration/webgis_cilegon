...
$query = "SELECT * FROM admin WHERE nama_pegawai LIKE '%$keyword%' OR nik LIKE '%$keyword%'";
$getdata = query($query);
?>
            ...
            <tbody>
                <?php foreach ($getdata as $i => $a) : ?>
                    <tr>
                        ...
                        <td><?= $a['nik']; ?></td>
                        <td class="text-center"><a href="form-update-akun.php?id=<?= $a["id"] ?>"><span class="badge bdg-a text-bg-warning p-2"><i class="fa-regular fa-pen-to-square"></i>
