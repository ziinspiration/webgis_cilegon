...
<div class="container-fluid">
    <h1 class="mt-5 mb-2 text-center text-dark">Update data atribut prasarana</h1>
                ...
                <tbody>
                    <?php foreach ($getdata as $a) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="text-warning me-2" href="ubah-atribut-prasarana?id=<?= $a['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
