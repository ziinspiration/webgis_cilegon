...
if (isset($_POST['send'])) {
    ...
    // Prepare statement
    $query = "INSERT INTO atribut_prasarana (data_pokok_id, data3, data4, data1, data2, data5, data6) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'tambah-data-atribut-prasarana?id=' + id_data_js;
            }
        });
        </script>";
        exit;
