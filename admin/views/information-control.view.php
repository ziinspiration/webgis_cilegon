        ...
        <div class="col-lg-4 col-md-6">
            ...
            <form action="" method="post" class="mb-3">
                <div class="add-marquee">
                        ...
                        <li>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_data"
                                    placeholder="Masukkan nama data" aria-label="Masukkan nama data"
                                    aria-describedby="tambahMarque">
                            </div>
                        </li>
                        <li>
                    ...
                    <button class="btn btn-primary p-1" type="submit" name="kirim_marque"><i
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" name="informasi" id="input-marque-<?= $marque['id']; ?>"
                                    data-id="<?= $marque['id']; ?>" data-type="marque" readonly
