...
<div class="container-fluid">
    <div class="row justify-content-center">
        <form action="" method="post" class="w-75 bg-dark rounded-2">
            <table class="table table-dark table-striped rounded-2" id="data-table">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <textarea class="form-control p-2" name="informasi" id="input-marque-<?= $marque['id']; ?>"
                                data-id="<?= $marque['id']; ?>" data-type="marquee" readonly
                                aria-describedby="<?= $marque['nama_data']; ?>"><?= $marque['informasi']; ?></textarea>
                        </td>
                        <td>
                            <i class="fa-regular fa-pen-to-square iFunction"
                                onclick="enableEdit('input-marque-<?= $marque['id']; ?>')"></i>
                            <i class="fa-solid fa-floppy-disk iFunction"
                                onclick="saveChanges('<?= $marque['id']; ?>', 'marque')"></i>
                            <i class="fa-solid fa-trash iFunction"
                                onclick="deleteData('<?= $marque['id']; ?>', 'marque')"></i>
                        </td>
            ...
            <p class="text-light mb-5 ms-2 mt-1"><small>*Tarik kolom informasi, jika ingin melihat lebih lengkap</small>
            </p>
            <form class="mt-5" action="" method="post">
                <h4 class="text-center orange mb-3">Tambah informasi</h4>
                <div class="p-3">
                    <input type="text" class="form-control nama-data-baru p-3 mb-2" name="nama_data"
                        placeholder="Masukkan nama informasi disini">
                    <textarea class="form-control form-tambah p-3" name="informasi"
                        placeholder="Masukkan isi informasi disini"></textarea>
