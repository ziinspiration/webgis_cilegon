...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6">
            ...
            <div class="alert text-center p-4 mb-4 alert-<?= $message['type'] ?> alert-dismissible fade show mt-3"
                role="alert">
                <?= $message['text'] ?>
            ...
            <form class="card w-100 p-5 mb-5 m-auto bg-dark" action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_pegawai" class="form-control username-input border-orange"
                        id="nama_pegawai" placeholder="Masukkan nama pegawai" required />
                </div>
                <!-- NIK -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <!-- Tambahkan span untuk menampilkan status keamanan password -->
