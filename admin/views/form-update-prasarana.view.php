...
<div class="container-fluid">
    <div class="row">
        <form class="form p-5 m-auto" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="nama_prasarana" class="form-label">Nama data</label>
                <input type="text" class="form-control" id="nama_prasarana" name="nama_prasarana" value="<?= $getdata['nama_prasarana']; ?>" required />
            </div>
