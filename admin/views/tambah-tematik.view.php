                ...
                <div class="formulir d-flex justify-content-between">
                    <div class="left w-50 me-3">
                        ...
                        <div class="mb-3 kolom">
                            ...
                            <input type="text" name="nama_tematik" class="form-control p-2" id="nama_tematik" placeholder="Masukkan nama data" />
                        </div>
                        <!-- File -->
                        <div class="mb-3 kolom">
                    ...
                    <div class="right w-50 ms-3 ">
                        ...
                        <div class="mb-3 kolom">
                            ...
                            <input type="text" name="checkbox_id" class="form-control p-2" id="checkbox_id" placeholder="*Wajib di isi untuk pembuatan checkbox" />
