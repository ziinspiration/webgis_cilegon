                    ...
                    <?php foreach ($getdata as $a) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="text-decoration-none" href="form-update-atribut-tematik?id=<?= $a["id_atribut"] ?>">
        ...
        hapusButtons[i].addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "functions/delete-atribut-tematik.php?id=" + hapusButtons[i]
                        .getAttribute(
                            'id_atribut');
                } else {
