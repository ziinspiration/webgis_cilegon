            ...
            <form class="px-5 py-4 bg-dark rounded-4" action="" method="post">
                ...
                <div class="mb-3 input-group">
                    ...
                    <input type="text" class="form-control p-1 px-2" name="informasi" value="<?= $a['informasi']; ?>"
                        id="input-alamat-<?= $a['id']; ?>" data-id="<?= $a['id']; ?>" data-type="alamat" readonly
                        aria-describedby="<?= $a['nama_data']; ?>">
                    <i class="fa-regular fa-pen-to-square ms-2 iFunction"
                        onclick="enableEdit('input-alamat-<?= $a['id']; ?>')"></i>
                    <i class="fa-solid fa-floppy-disk ms-2 iFunction"
                        onclick="saveChanges('<?= $a['id']; ?>', 'alamat')"></i>
                </div>
                <?php endforeach; ?>
                ...
                <div class="mb-3 input-group">
                    ...
                    <input type="text" class="form-control p-1 px-2" name="informasi" value="<?= $a['informasi']; ?>"
                        id="input-email-<?= $a['id']; ?>" data-id="<?= $a['id']; ?>" data-type="email" readonly
                        aria-describedby="<?= $a['nama_data']; ?>">
                    <i class="fa-regular fa-pen-to-square ms-2 iFunction"
                        onclick="enableEdit('input-email-<?= $a['id']; ?>')"></i>
                    <i class="fa-solid fa-floppy-disk ms-2 iFunction"
                        onclick="saveChanges('<?= $a['id']; ?>', 'email')"></i>
                </div>
                <?php endforeach; ?>
                ...
                <div class="mb-3 input-group input-group">
                    ...
                    <input type="text" class="form-control p-1 px-2" name="informasi" value="<?= $a['informasi']; ?>"
                        id="input-telphone-<?= $a['id']; ?>" data-id="<?= $a['id']; ?>" data-type="telphone" readonly
                        aria-describedby="<?= $a['nama_data']; ?>">
                    <i class="fa-regular fa-pen-to-square ms-2 iFunction"
                        onclick="enableEdit('input-telphone-<?= $a['id']; ?>')"></i>
                    <i class="fa-solid fa-floppy-disk ms-2 iFunction"
                        onclick="saveChanges('<?= $a['id']; ?>', 'telphone')"></i>
                </div>
                <?php endforeach; ?>
