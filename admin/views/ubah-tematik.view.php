                ...
                <tbody>
                    <?php foreach ($getdata as $i => $a) : ?>
                        <tr>
                            ...
                            <td><a class="text-dark text-decoration-none" href="detail-tematik.php?id=<?= $a["id"] ?>"><?= $a['nama_tematik']; ?></a></td>
                            <td><?= $a['file_json']; ?></td>
                            <td class="text-center">
                                <a class="text-decoration-none" href="form-update-tematik.php?id=<?= $a["id"] ?>">
