...
<h2 class="text-center mt-4 mb-3">Detail data <?= $getdata['nama_prasarana']; ?></h2>
                        ...
                        <tbody>
                            ...
                            <?php if ($getdata['nama_jenis'] === 'Marker') : ?>
                                <tr class="kolom">
                                    <th>Icon :</th>
                                    <td>
                                        <img class="w-25 align-content-center" src="../assets/icon/prasarana/<?= $getdata['icon']; ?>" alt="">
                                    </td>
                                </tr>
                                <tr class="kolom">
                                    <th>Icon id :</th>
