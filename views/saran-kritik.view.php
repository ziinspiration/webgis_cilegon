...
<div class="container mb-5 mt-5">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php echo $first ? 'active' : ''; ?>">
                    <div class="">
                        <div class="content">
                            <div class="question">
                                <p class="m-0 q mb-1"><b><span class="me-1" id="profile-icon"><i
                                                class="bi bi-person-circle"></i></span><?= $a['nama_pengguna']; ?></b>
                                </p>
    ...
    <div class="card pb-5 px-4 mt-5 pt-3 rounded bg-body-tertiary">
        <form action="" method="post" id="saranForm">
            ...
            <div class="form-floating mb-3 text-secondary">
                <input type="text" class="form-control pt-4" id="nama_pengguna" name="nama_pengguna"
            ...
            <input type="hidden" name="jawaban_otomatis"
                value="Terima kasih atas saran dan kritik Anda. Kami menghargai kontribusi anda untuk meningkatkan layanan WebGIS kami. Kami akan terus berusaha memperbaiki platform kami sesuai masukan Anda. Terima kasih atas dukungan Anda.">
            <div class="d-flex justify-content-end mt-2">
                <button type="submit" class="btn btn-primary" id="kirimButton"><i class="fa-solid fa-paper-plane"></i>
                    Kirim</button>
            </div>
        </form>
    </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($nama_pengguna) || empty($isi)) {
            echo "<script>
            Swal.fire({
                title: 'Peringatan!',
                text: 'Nama Pengguna dan Saran & Kritikan harus diisi.',
                icon: 'warning',
            ...
            echo "<script>document.getElementById('loading-spinner').style.display = 'flex';</script>";
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                Swal.fire({
                    ...
                    window.location.href = 'saran-kritik';
                });
            </script>";
                exit;
            } else {
