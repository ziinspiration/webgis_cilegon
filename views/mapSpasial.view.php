    ...
    function showPopup(feature, layer) {
        ...
        if (feature.properties) {
            ...
            if (feature.properties.NM_RS_EKS) {
                popupContent += "<p><b>Nama ruas eksisting :</b> " + feature.properties.NM_RS_EKS + "</p>";
            }
            if (feature.properties.NM_LK_SK) {
                popupContent += "<p><b>Nama lingkungan eksisting :</b> " + feature.properties.NM_LK_SK + "</p>";
            }
