        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="about">
                    ...
                    <p class="text-light">Website Geospasial BAPPEDALITBANG Kota Cilegon adalah platform online yang
                        menyajikan
                        informasi peta dan
    ...
    <div class="footer-copyright mt-5">
        <div class="container-foot">
            <div class="row">
                ...
                <p class="text-center cprg text-white-50">© 2023 Website Geospasial BAPPEDALITBANG Kota Cilegon. All
                    rights
                    reserved.
                </p>
            </div>
