                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="text-decoration-none"
                                href="form-update-atribut-prasarana?id=<?= $a["id_atribut"] ?>">
                                <span class="badge bdg-a text-bg-warning p-2"><i
                                        class="fa-regular fa-pen-to-square"></i>Ubah</span>
                            </a>
                            <span class="fw-bold spase">|</span>
                            <a href="javascript:void(0);" class="hapusData" data-id-atribut="<?= $a["id_atribut"] ?>"
                                data-id-pokok="<?= $a["id_pokok"] ?>">
    ...
    hapusButtons[i].addEventListener('click', function(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "functions/delete-atribut-prasarana.php?id_atribut=" +
