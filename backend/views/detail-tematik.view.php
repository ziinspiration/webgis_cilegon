...
<h2 class="text-center mt-4 mb-3">Detail data <?= $getdata['nama_tematik']; ?></h2>
...
<script>
    ...
    // Get data
    $.getJSON("../assets/geojson/tematik/<?= $getdata['file_json']; ?>", function(data) {
