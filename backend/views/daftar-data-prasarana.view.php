...
<div class="container-fluid">
    <h1 class="mt-5 mb-2 text-center text-dark">Daftar data pokok prasarana</h1>
                ...
                <tbody>
                    <?php foreach ($getdata as $a) : ?>
                        <tr>
                            ...
                            <td><?= $a['nama_data']; ?></td>
                            <td><a href="detail-data-prasarana?id=<?= $a['id']; ?>"><i class="fa-solid fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<script>
    ...
    keyword.onkeyup = function() {
        fetch("ajax/search-data-prasarana.php?keyword=" + keyword.value)
