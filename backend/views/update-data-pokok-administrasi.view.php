...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE data_administrasi SET nama_data='$nama_data' WHERE id='$id'";
...
<div class="container-fluid">
    <h1 class="mt-5 mb-2 text-center text-dark">Update data pokok administrasi</h1>
            ...
            <?php if (strpos($message, "successfully") !== false) : ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'update-data-pokok-administrasi'; // Ganti dengan URL halaman tujuan
                    }
                });
            <?php else : ?>
                Swal.fire({
        ...
        hapusButtons[i].addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "functions/delete-pokok-administrasi.php?id=" + hapusButtons[i]
                        .getAttribute(
                            'id_pokok');
                } else {
