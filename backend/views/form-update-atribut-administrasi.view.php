    ...
    <div class="row justify-content-center">
        <div class="w-75 align-content-center">
            <form class="px-5 py-4 bg-dark rounded-4" action="" method="POST" enctype="multipart/form-data">
                <h2 class="text-center text-light mb-5 mt-2">Update data atribut administrasi</h2>

                <div class="formulir">
                    <div class="left w-100 me-3">
                        <div class="mb-3">
                            <label for="provinsi" class="form-label orange ps-1 pe-1">Provinsi</label>
                            <input type="text" class="form-control p-2" id="provinsi" name="provinsi" value="<?= $getdata['provinsi']; ?>" required />
                        </div>
                        <div class="mb-3">
                            <label for="kabupaten" class="form-label orange ps-1 pe-1">Kabupaten</label>
                            <input type="text" class="form-control p-2" id="kabupaten" name="kabupaten" value="<?= $getdata['kabupaten']; ?>" required />
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="right w-100 me-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control p-2" id="kelurahan" name="kelurahan" value="<?= $getdata['kelurahan']; ?>" required />
                        </div>
                        <div class="mb-3">
                            <label for="sumber" class="form-label orange ps-1 pe-1">Sumber</label>
                            <input type="text" class="form-control p-2" id="sumber" name="sumber" value="<?= $getdata['sumber']; ?>" required />
                        </div>
                        <div class="mb-3">
                            <label for="luas" class="form-label orange ps-1 pe-1">Luas</label>
                            <input type="text" class="form-control p-2" id="luas" name="luas" value="<?= $getdata['luas']; ?>" required />
                        </div>
...
if (isset($_POST["submit"])) {
    ...
    $query = "UPDATE atribut_administrasi SET
            provinsi = '$provinsi',
            kabupaten = '$kabupaten',
            kecamatan = '$kecamatan',
            kelurahan = '$kelurahan',
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $redirectUrl = "ubah-atribut-administrasi?id=" . urlencode($id_pokok);
        $icon = 'success';
    } else {
