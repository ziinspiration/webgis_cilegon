...
if (isset($_POST['send'])) {
    ...
    // Prepare statement
    $query = "INSERT INTO data_prasarana (nama_data) VALUES (?)";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $successMessage = "Data berhasil ditambahkan ke tabel data prasarana";
        echo "
            <script>
                Swal.fire({
                    icon: 'success',
                    ...
                    window.location.href = 'daftar-data-prasarana';
                });
            </script>
        ";
        exit;
