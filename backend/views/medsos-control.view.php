        ...
        <div class="w-75 content align-content-center">
            <form class="px-5 py-4 bg-dark rounded-4" action="" method="post">
                ...
                <div class="mb-3 input-group input-group">
                    ...
                    <input type="text" class="form-control p-1 px-2" name="informasi" value="<?= $a['informasi']; ?>"
                        id="input-instagram-<?= $a['id']; ?>" data-id="<?= $a['id']; ?>" data-type="instagram" readonly
                        aria-describedby="<?= $a['nama_data']; ?>">
                    <i class="fa-regular fa-pen-to-square ms-2 iFunction"
                        onclick="enableEdit('input-instagram-<?= $a['id']; ?>')"></i>
                    <i class="fa-solid fa-floppy-disk ms-2 iFunction"
                        onclick="saveChanges('<?= $a['id']; ?>', 'instagram')"></i>
                </div>
                <?php endforeach; ?>
                ...
                <div class="mb-3 input-group">
                    ...
                    <input type="text" class="form-control p-1 px-2" name="informasi" value="<?= $a['informasi']; ?>"
                        id="input-facebook-<?= $a['id']; ?>" data-id="<?= $a['id']; ?>" data-type="facebook" readonly
                        aria-describedby="<?= $a['nama_data']; ?>">
                    <i class="fa-regular fa-pen-to-square ms-2 iFunction"
                        onclick="enableEdit('input-facebook-<?= $a['id']; ?>')"></i>
                    <i class="fa-solid fa-floppy-disk ms-2 iFunction"
                        onclick="saveChanges('<?= $a['id']; ?>', 'facebook')"></i>
                </div>
                <?php endforeach; ?>
                ...
                <div class="mb-3 input-group">
                    ...
                    <input type="text" class="form-control p-1 px-2" name="informasi" value="<?= $a['informasi']; ?>"
                        id="input-youtube-<?= $a['id']; ?>" data-id="<?= $a['id']; ?>" data-type="youtube" readonly
                        aria-describedby="<?= $a['nama_data']; ?>">
                    <i class="fa-regular fa-pen-to-square ms-2 iFunction"
                        onclick="enableEdit('input-youtube-<?= $a['id']; ?>')"></i>
                    <i class="fa-solid fa-floppy-disk ms-2 iFunction"
                        onclick="saveChanges('<?= $a['id']; ?>', 'youtube')"></i>
                </div>
                <?php endforeach; ?>
                ...
                <div class="mb-3 input-group">
                    ...
                    <input type="text" class="form-control p-1 px-2" name="informasi" value="<?= $a['informasi']; ?>"
                        id="input-twitter-<?= $a['id']; ?>" data-id="<?= $a['id']; ?>" data-type="twitter" readonly
                        aria-describedby="<?= $a['nama_data']; ?>">
                    <i class="fa-regular fa-pen-to-square ms-2 iFunction"
                        onclick="enableEdit('input-twitter-<?= $a['id']; ?>')"></i>
                    <i class="fa-solid fa-floppy-disk ms-2 iFunction"
                        onclick="saveChanges('<?= $a['id']; ?>', 'twitter')"></i>
                </div>
                <?php endforeach; ?>
