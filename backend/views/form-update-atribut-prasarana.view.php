    ...
    <div class="row justify-content-center">
        <div class="w-75 align-content-center">
            <form class="px-5 py-4 bg-dark rounded-4" action="" method="POST" enctype="multipart/form-data">
                <h2 class="text-center text-light mb-5 mt-2">Update data atribut prasarana</h2>
...
if (isset($_POST["submit"])) {
    ...
    $query = "UPDATE atribut_prasarana SET
            nama = '$nama',
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $redirectUrl = "ubah-atribut-prasarana?id=" . urlencode($id_pokok);
        $icon = 'success';
    } else {
