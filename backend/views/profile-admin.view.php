                ...
                <form enctype="multipart/form-data">
                    <div class="profile-picture d-flex flex-column mb-4">
                        ...
                        <input type="file" onchange="previewImage(this)"
                            class="form-control input-image w-50 p-2 mt-2 grup" name="new_foto_profile"
                            accept="image/*">
                    </div>
                    <hr class="mb-4">
                    <div class="input-group mb-3 w-75 d-flex align-items-center grup">
                        ...
                        <input type="text" class="form-control p-3" name="nama_pegawai"
                            value="<?= $admin['nama_pegawai']; ?>" aria-describedby="basic-addon1" readonly>
                    ...
                    <div class="input-nik mb-3">
                        <div class="input-group w-75 d-flex align-items-center grup">
                            <span class="input-group-text p-3" id="basic-addon1"><i
                                    class="fa-solid fa-id-badge"></i></span>
                            <input type="text" class="form-control p-3" name="nik" id="nik"
                                value="<?= $admin['nik']; ?>" aria-describedby="basic-addon1" readonly>
                    ...
                    <p>Apakah anda ingin merubah password ? <a class="text-decoration-none"
                            href="../auth/change-password?id=<?= $admin["id"] ?>">KLIK
                            DISINI</a></p>
            </div>
            <div class="button d-flex justify-content-end mb-5">
                <button type="button" class="btn btn-primary me-5 p-2 px-3 rounded" onclick="saveChanges()"><i
