...
<div class="container-fluid">
    <h1 class="mt-5 mb-2 text-center text-dark">Daftar data SKPD</h1>
...
<script>
    ...
    keyword.onkeyup = function() {
        fetch("ajax/search-update-skpd.php?keyword=" + keyword.value)
        ...
        hapusButtons[i].addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    console.log("Data dengan ID " + hapusButtons[i].getAttribute('id_skpd') +
                        " telah dihapus!");

                    // Perform deletion action (e.g., delete data from the server)
                    window.location.href = "functions/delete-skpd.php?id=" + hapusButtons[i]
                        .getAttribute(
                            'id_skpd');
                } else {
