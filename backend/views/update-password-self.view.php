            ...
            <form action="" method="post" class="card p-4 bg-dark rounded-4">
                <div class="form-group mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <input type="password" class="form-control pt-1 pb-1" id="current_password"
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        <i class="bi icon bi-lock-fill me-1 text-secondary"></i>
                        <input type="password" class="form-control pt-1 pb-1" id="new_password" name="new_password"
                ...
                <div class="form-group mb-5">
                    ...
                    <div class="d-flex align-items-center">
                        <i class="bi icon bi-lock-fill me-1 text-secondary"></i>
                        <input type="text" class="form-control pt-1 pb-1" id="confirm_password" name="confirm_password"
