    ...
    <div class="row justify-content-center">
        <div class="w-75 align-content-center">
            <form class="px-5 py-4 bg-dark rounded-4" action="" method="POST" enctype="multipart/form-data">
                <h2 class="text-center text-light mb-5 mt-2">Update data atribut tematik</h2>
                ...
                <div class="formulir">
                    <div class="left w-100 me-3">
                        ...
                        <div class="mb-3">
                            <label for="fungsi" class="form-label orange ps-1 pe-1">Fungsi</label>
                            <input type="text" class="form-control p-2" id="fungsi" name="fungsi" value="<?= $getdata['fungsi']; ?>" />
                        </div>
                    </div>
...
if (isset($_POST["submit"])) {
    ...
    $query = "UPDATE atribut_tematik SET
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $redirectUrl = "ubah-atribut-tematik?id=" . urlencode($id_pokok);
        $icon = 'success';
    } else {
